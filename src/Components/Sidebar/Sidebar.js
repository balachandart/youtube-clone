  ...
  return (
    ...
    <div className={`sidebar ${SideBar?"":"small-sidebar"}`}>
      <div className="sortcut-links">
        ...
        <div className={`side-links ${category===28?"active":""}`}  onClick={()=>setCategory(10)}>
          <img src={tech} alt="" /><p>Tech</p>  
        </div>

        <div className={`side-links ${category===10?"active":""}`}  onClick={()=>setCategory(28)}>
        ...
        <div className="subscribed-list">
          ...
          <div className="side-links">
            <img src={jack} alt="" /><p>Bala's TechInfo</p>
          </div>

          <div className="side-links">
            <img src={cameron} alt="" /><p>Suvi's Kitchen</p>
          </div>

          <div className="side-links">
            <img src={simon} alt="" /><p>Mohan vlogs</p>
          </div>

          <div className="side-links">
            <img src={tom} alt="" /><p>Abdul Kalam Quotes</p>
          </div>

          <div className="side-links">
            <img src={megan} alt="" /><p>Adithi Vlogs</p>
          </div>
        </div>
      </div>
